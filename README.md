      ...
      <div class="reg-body">
        ...
        <div id="regForm">
          ...
          <div class="payment-box">
            <p>Plan অনুযায়ী নিচের বাটনে click করুন — payment app খুলবে:</p>
            <div class="upi-id">ajsuajsu71@oksbi</div>
            <a href="upi://pay?pa=ajsuajsu71@oksbi&pn=Test%20Bazar&am=99&cu=INR" class="upi-pay-btn" style="display:block;margin-top:0.6rem">
              📲 মাসিক ₹৯৯ — এখানে click করুন
            </a>
            <a href="upi://pay?pa=ajsuajsu71@oksbi&pn=Test%20Bazar&am=999&cu=INR" class="upi-pay-btn" style="display:block;margin-top:0.5rem;background:#0f5c38">
              📲 বার্ষিক ₹৯৯৯ — এখানে click করুন
            </a>
